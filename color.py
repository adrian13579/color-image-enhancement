...
def provenzi_caselles(wp, alpha, wj, k):
    ...
    while len(scale_index) >= 0:
        ...
        wp[scale_index + "h"] = local_contrast_enhancement(
            wp[scale_index + "h"].data, a_j, wj, k
        )
        wp[scale_index + "v"] = local_contrast_enhancement(
            wp[scale_index + "v"].data, a_j, wj, k
        )
        wp[scale_index + "d"] = local_contrast_enhancement(
            wp[scale_index + "d"].data, a_j, wj, k
        )
